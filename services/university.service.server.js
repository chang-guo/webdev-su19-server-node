module.exports = function (app) {
    ...
    function findAllQuestions(req, res) {
       universityDao.findAllQuestions().then(x=>res.send(x))
    }
    ...
    function findAllAnswers(req, res) {
        universityDao.findAllAnswers().then(x=>res.send(x))
    }
    ...
    function getAllAnswersForStudent(req, res) {
        universityDao.findAnswersByStudent(req.params['sid']).then(x=>res.send(x))
    }
